...
function createRoomMetrics(room, syncConfig) {
  return {
    ...
    battleQueuedProjectileFires: 0,
    battleQueuedProjectileHits: 0,
    battleQueuedKartCrashes: 0,
    battleDroppedProjectileFires: 0,
    battleDroppedProjectileHits: 0,
    battleDroppedKartCrashes: 0,
    battleFlushedProjectileFires: 0,
    battleFlushedProjectileHits: 0,
    battleFlushedKartCrashes: 0,
    lastPatchAt: 0,
    lastSyncAt: 0,
  };
}
...
export function getRealtimeMetricsSnapshot(room) {
  ...
  return {
    ...
    battleQueuedProjectileFires: metrics?.battleQueuedProjectileFires || 0,
    battleQueuedProjectileHits: metrics?.battleQueuedProjectileHits || 0,
    battleQueuedKartCrashes: metrics?.battleQueuedKartCrashes || 0,
    battleDroppedProjectileFires: metrics?.battleDroppedProjectileFires || 0,
    battleDroppedProjectileHits: metrics?.battleDroppedProjectileHits || 0,
    battleDroppedKartCrashes: metrics?.battleDroppedKartCrashes || 0,
    battleFlushedProjectileFires: metrics?.battleFlushedProjectileFires || 0,
    battleFlushedProjectileHits: metrics?.battleFlushedProjectileHits || 0,
    battleFlushedKartCrashes: metrics?.battleFlushedKartCrashes || 0,
