...
export const KARTS = [
  ...
  { id: 'amazing_panda',   label: 'Amazing Panda',    modelPath: '/models/stk/karts/amazing_panda/kart.glb',   weight: 'heavy',  accent: '#ffffff' },
  { id: 'bea',             label: 'Bea',              modelPath: '/models/stk/karts/bea/kart.glb',             weight: 'light',  accent: '#ffd866' },
  { id: 'beagle_2',        label: 'Beagle',           modelPath: '/models/stk/karts/beagle_2/kart.glb',        weight: 'medium', accent: '#c98a5b' },
  { id: 'carrot',          label: 'Carrot',           modelPath: '/models/stk/karts/carrot/kart.glb',          weight: 'light',  accent: '#ff8c1a' },
  { id: 'chibi',           label: 'Chibi',            modelPath: '/models/stk/karts/chibi/kart.glb',           weight: 'light',  accent: '#ff6ec7' },
  { id: 'cyberkart',       label: 'Cyberkart',        modelPath: '/models/stk/karts/cyberkart/kart.glb',       weight: 'light',  accent: '#ff00ea' },
  { id: 'elephpant',       label: 'Elephpant',        modelPath: '/models/stk/karts/elephpant/kart.glb',       weight: 'heavy',  accent: '#8888ff' },
  ...
  { id: 'liz',             label: 'Liz',              modelPath: '/models/stk/karts/liz/kart.glb',             weight: 'medium', accent: '#ff5e7e' },
  { id: 'minix',           label: 'Minix',            modelPath: '/models/stk/karts/minix/kart.glb',           weight: 'light',  accent: '#7afff0' },
  { id: 'mr_iceblock',     label: 'Mr. Iceblock',     modelPath: '/models/stk/karts/mr_iceblock/kart.glb',     weight: 'heavy',  accent: '#a8eaff' },
  { id: 'oem',             label: 'OEM',              modelPath: '/models/stk/karts/oem/kart.glb',             weight: 'medium', accent: '#cccccc' },
  { id: 'ozom',            label: 'Ozom',             modelPath: '/models/stk/karts/ozom/kart.glb',            weight: 'medium', accent: '#ffaa00' },
  { id: 'p2000',           label: 'P2000',            modelPath: '/models/stk/karts/p2000/kart.glb',           weight: 'medium', accent: '#222222' },
  { id: 'pidgin',          label: 'Pidgin',           modelPath: '/models/stk/karts/pidgin/kart.glb',          weight: 'light',  accent: '#b2dbef' },
  { id: 'pidgin_2020',     label: 'Pidgin 2020',      modelPath: '/models/stk/karts/pidgin_2020/kart.glb',     weight: 'light',  accent: '#7ec5e8' },
  ...
  { id: 'rx173',           label: 'RX-173',           modelPath: '/models/stk/karts/rx173/kart.glb',           weight: 'medium', accent: '#ff7733' },
  { id: 'sara_the_racer',  label: 'Sara (Racer)',     modelPath: '/models/stk/karts/sara_the_racer/kart.glb',  weight: 'medium', accent: '#ff77aa' },
  { id: 'sara_the_wizard', label: 'Sara (Wizard)',    modelPath: '/models/stk/karts/sara_the_wizard/kart.glb', weight: 'medium', accent: '#cc88ff' },
  { id: 'sepia',           label: 'Sepia',            modelPath: '/models/stk/karts/sepia/kart.glb',           weight: 'medium', accent: '#a07d4f' },
  { id: 'toots',           label: 'Toots',            modelPath: '/models/stk/karts/toots/kart.glb',           weight: 'light',  accent: '#ffd966' },
  { id: 'transmission',    label: 'Transmission',     modelPath: '/models/stk/karts/transmission/kart.glb',    weight: 'medium', accent: '#7777aa' },
  { id: 'wilber',          label: 'Wilber',           modelPath: '/models/stk/karts/wilber/kart.glb',          weight: 'heavy',  accent: '#ff9933' },
  { id: 'xue',             label: 'Xue',              modelPath: '/models/stk/karts/xue/kart.glb',             weight: 'light',  accent: '#ffffff' },
];
